	...
	return {
		...
		template: '<div class="form-control peoplepicker-wrapper">' +
							'<ul class="peoplepicker-list" ng-show="selected.length > 0">' +
								...
								'</li>' +
							'</ul>' +
							'<input class="peoplepicker-input"  ng-model="findPeople" type="text" placeholder="ֲגוהטעו במכוו 3 סטלגמכמג" typeahead-on-select="getSelectedPeople()" typeahead="address for address in getPeople($viewValue)" typeahead-loading="loadingLocations">' +
